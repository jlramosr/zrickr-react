...
name, label, description, default, required, relation, items

type:
  list (items=si relation => items de relation, sino items),
  select (items=si relation => items de relation, sino items),
